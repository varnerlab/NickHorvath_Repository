function calculate_constraints(state_array, parameters, constraint_index, syn_data,time_index,tstep)
  ...
  state_array = max(0,state_array);println(size(state_array))
...
#  species_lower_bound[145] = (1/tstep)*0.95*state_array[145]  # -.05*state_array[145]
#  species_upper_bound[145] = (1/tstep)*1.05*state_array[145]  #.05*state_array[145]
