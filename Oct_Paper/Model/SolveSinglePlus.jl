...
species_array = readdlm("Results/Plus/species_array")
writedlm("Results/Plus/species_array",species_array[2:end,:])

species_constraint_label = species_array[1,1]
println(species_constraint_label)
mkdir("Results/Plus/$species_constraint_label")

species_constraint_index = species_array[1,2:end]
species_constraint_index = find(species_constraint_index.!="")
writedlm("Results/Plus/$species_constraint_label/species_constraint_index", species_constraint_index)
...
#end
#end
#writedlm("Results/Plus/species_constraint_labels",Labels)
#writedlm("Results/Plus/species_array",[Labels species_constraint_array])
...
#	Accuracy[constraint_index] = accuracy
	writedlm("Results/Plus/$species_constraint_label/accuracy",accuracy)
...
#	Precision[constraint_index] = precision
	writedlm("Results/Plus/$species_constraint_label/precision",precision)

	# save all states
	
#	EXIT_FLAG[:,constraint_index] = Exit_flag
	writedlm("Results/Plus/$species_constraint_label/Exit_flag",Exit_flag)
	writedlm("Results/Plus/$species_constraint_label/Flux_array",Flux_array)
	writedlm("Results/Plus/$species_constraint_label/Dual_array",Dual_array)
	writedlm("Results/Plus/$species_constraint_label/Uptake_array",Uptake_array)
