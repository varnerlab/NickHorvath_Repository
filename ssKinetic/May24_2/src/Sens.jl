...
sat = readdlm("Best/saturation_constant.dat")
cont = readdlm("Best/control_constant.dat")
...
Tsim_best = vec(readdlm("Best/Tsim"))
X_best = readdlm("Best/X")
...
IJ = convert(Array{Int64},readdlm("Sens/IJ"))

#if num_dir==size(IJ,1)
#	throw("--Done--Done--Done--Done--Done--Done--Done--Done--")
#end
...
#	data_dictionary["RATE_CONSTANT_ARRAY"][j] = data_dictionary["RATE_CONSTANT_ARRAY"][i]*perturbation
	...
	writedlm("Sens/$str/prod_sens",CAT_sens)
