...
axis([0,3,0,3e-7])
plt[:xticks](0:1:3)
plt[:yticks](0:1e-7:3e-7)
ylabel("mRNA_CAT (mM)")
xlabel("Time (h)")

subplot(3,3,5)
plot(Tsim,1e3*X[:,76],plot_color)
axis([0,3,0,3])
plt[:xticks](0:1:3)
plt[:yticks](0:1:3)
ylabel("Ribosome (microM)")
xlabel("Time (h)")

subplot(3,3,6)
plot(Tsim,1e3*X[:,77],plot_color)
axis([0,3,0,3])
plt[:xticks](0:1:3)
plt[:yticks](0:1:3)
ylabel("Ribosome_START_CAT (microM)")
xlabel("Time (h)")
