...
function CalcYield_KO_cyd(set_number)
...
if ~isdir("KO_cyd/$set_number")
    mkdir("KO_cyd/$set_number")
end

writedlm("KO_cyd/$set_number/params",params)
writedlm("KO_cyd/$set_number/Tsim",Tsim)
writedlm("KO_cyd/$set_number/X",X)
writedlm("KO_cyd/$set_number/yield",yield)
