...
function CalcYield_KO_app(set_number)
...
if ~isdir("KO_app/$set_number")
    mkdir("KO_app/$set_number")
end

writedlm("KO_app/$set_number/params",params)
writedlm("KO_app/$set_number/Tsim",Tsim)
writedlm("KO_app/$set_number/X",X)
writedlm("KO_app/$set_number/yield",yield)
