...
function CalcYield_KO_nuo(set_number)
...
if ~isdir("KO_nuo/$set_number")
    mkdir("KO_nuo/$set_number")
end

writedlm("KO_nuo/$set_number/params",params)
writedlm("KO_nuo/$set_number/Tsim",Tsim)
writedlm("KO_nuo/$set_number/X",X)
writedlm("KO_nuo/$set_number/yield",yield)
